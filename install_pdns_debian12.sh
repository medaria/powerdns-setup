...
echo "PowerDNS Installation Script for Debian 12 (Bookworm) with 48-Character Passwords"
...
echo "deb [signed-by=/etc/apt/keyrings/auth-49-pub.asc] http://repo.powerdns.com/debian bookworm-auth-49 main" > /etc/apt/sources.list.d/pdns.list
echo "Package: auth*
